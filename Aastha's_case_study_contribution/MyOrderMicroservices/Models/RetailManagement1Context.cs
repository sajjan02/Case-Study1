...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("server=CL-F7JL9Y3;Database=retail_management1;Integrated Security=true;trust server certificate=true");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Address>(entity =>
        {
            entity.HasKey(e => e.AddressId).HasName("PK__Address__CAA247C8FEBDE86D");
        ...
        {
            entity.HasKey(e => e.CartId).HasName("PK__Carts__2EF52A2780125FB3");
        ...
        {
            entity.HasKey(e => e.CartItemId).HasName("PK__CartItem__5D9A6C6E50D0873D");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__D54EE9B4A4E94B51");
        ...
        {
            entity.HasKey(e => e.DiscountId).HasName("PK__Discount__BDBE9EF95220E417");
        ...
        {
            entity.HasKey(e => e.TransactionId).HasName("PK__Inventor__85C600AFC5B4AA67");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__E059842FB77C5716");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__46596229D69FF167");
        ...
        {
            entity.HasKey(e => e.OrderItemId).HasName("PK__OrderIte__3764B6BC6785AD05");
        ...
        {
            entity.HasKey(e => e.OrderPaymentId).HasName("PK__OrderPay__E3A60BC08F2E9F9A");
        ...
        {
            entity.HasKey(e => e.OrderDiscountId).HasName("PK__Orders_D__93C1FE8B6A9F85D8");
        ...
        {
            entity.HasKey(e => e.PaymentMethodId).HasName("PK__PaymentM__8A3EA9EB695B3D71");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__47027DF5C033CF35");
        ...
        {
            entity.HasKey(e => e.ProductCategoryId).HasName("PK__ProductC__1F8847F92259FC07");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__Reviews__60883D90A6894B32");
        ...
        {
            entity.HasKey(e => e.ShipmentId).HasName("PK__Shipment__41466E59951ED63F");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__B9BE370FD3550463");
        ...
        {
            entity.HasKey(e => e.WishlistId).HasName("PK__Wishlist__6151514EEC1888BC");
        ...
        {
            entity.HasKey(e => e.WishlistItemId).HasName("PK__Wishlist__190EBE28AEF391F6");
